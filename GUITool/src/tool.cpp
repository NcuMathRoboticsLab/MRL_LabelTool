 ...
 * @brief The main function of the GUI. It will called the main function of each window
 * @version 0.1
 * @date 2023-01-24
 *
...
int main(int, char **)
{
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    // If you want to watch the implementation of this GUI, check the 3 functions below.
